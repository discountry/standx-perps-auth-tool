import{cw as A,db as l,cz as w,cA as D,cB as C,cS as $,cI as h,cC as u,cY as V,cP as N,cL as S,cU as M,dm as K,cQ as F,cR as Q,cx as W,cy as H,dH as _}from"./index-Bp3qVQ4S.js";import{S as s}from"./SwapController-Bh0S1-k6.js";import"./index-KygTkUTU.js";const q={numericInputKeyDown(e,t,o){const i=["Backspace","Meta","Ctrl","a","A","c","C","x","X","v","V","ArrowLeft","ArrowRight","Tab"],r=e.metaKey||e.ctrlKey,n=e.key,a=n.toLocaleLowerCase(),c=a==="a",b=a==="c",I=a==="v",E=a==="x",U=n===",",R=n===".",B=n>="0"&&n<="9";!r&&(c||b||I||E)&&e.preventDefault(),t==="0"&&!U&&!R&&n==="0"&&e.preventDefault(),t==="0"&&B&&(o(n),e.preventDefault()),(U||R)&&(t||(o("0."),e.preventDefault()),(t!=null&&t.includes(".")||t!=null&&t.includes(","))&&e.preventDefault()),!B&&!i.includes(n)&&!R&&!U&&e.preventDefault()}},G=A`
  :host {
    width: 100%;
  }
