import{dm as x,dK as ae,cL as c,cN as de,cw as C,cx as L,cA as w,cB as y,cC as d,cz as l,d1 as W,cW as _,db as u,cy as ue,cE as D,cS as g,d9 as j,dG as he,dt as V,cP as U,dj as R,c_ as F,cH as pe,cM as O,dp as z,dD as ee,da as me,cG as ne,dL as fe,dM as we}from"./index-CJRZSWFa.js";import"./index-DwdLI4pF.js";import{S as be}from"./SwapController-R_G7XfT6.js";const se={isUnsupportedChainView(){return c.state.view==="UnsupportedChain"||c.state.view==="SwitchNetwork"&&c.state.history.includes("UnsupportedChain")},async safeClose(){if(this.isUnsupportedChainView()){x.shake();return}if(await ae.isSIWXCloseDisabled()){x.shake();return}(c.state.view==="DataCapture"||c.state.view==="DataCaptureOtpConfirm")&&de.disconnect(),x.close()}},ge=C`
  :host {
    display: block;
